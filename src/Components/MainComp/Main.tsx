...
export default function Main() {
  return (
    <>
    <div className="container relative py-10 lg:min-h-[100vh] overflow-y-hidden   mx-auto bg-[#030406] ">
    <img className=' left-[50%]  z-[5]  translate-x-[-50%] head-shadow  bottom-[-200px]  absolute h-[70vh]   lg:h-[100vh]' src="/mainimg.webp" alt="" />
